...
public class BigRatingStarLayout extends LinearLayout {
    ...
    public BigRatingStarLayout(Context context) {
        this(context, null);
    }

    public BigRatingStarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BigRatingStarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        View view = inflate(getContext(), R.layout.view_rating_big_star, null);
        initialize(view);
