...
public class MiddleRatingStarLayout extends LinearLayout {
    ...
    public MiddleRatingStarLayout(Context context) {
        this(context, null);
    }

    public MiddleRatingStarLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MiddleRatingStarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        View view = inflate(getContext(), R.layout.view_rating_middle_star, null);
        initialize(view);
