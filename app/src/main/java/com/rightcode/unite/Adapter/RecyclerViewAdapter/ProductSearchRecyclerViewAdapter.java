...
import com.rightcode.unite.Adapter.ViewHolder.ProductSearchViewHolder;
...
public class ProductSearchRecyclerViewAdapter extends RecyclerView.Adapter<CommonRecyclerViewHolder> {
    ...
    public CommonRecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_product_search_recyclerview, viewGroup, false);
        return new ProductSearchViewHolder(view, mContext);
    }
    ...
    public void onBindViewHolder(@NonNull CommonRecyclerViewHolder viewHolder, int position) {
        ((ProductSearchViewHolder) viewHolder).onBind(data.get(position));
    }
