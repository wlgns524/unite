...
public class ProductSearchViewHolder extends CommonRecyclerViewHolder implements View.OnClickListener {
    ...
    public ProductSearchViewHolder(View viewHolder, Context context) {
