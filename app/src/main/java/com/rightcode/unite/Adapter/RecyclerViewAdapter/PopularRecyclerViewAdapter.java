...
public class PopularRecyclerViewAdapter extends RecyclerView.Adapter<CommonRecyclerViewHolder> {
...
//    List<Integer> arr = Arrays.asList(new Integer[10]);
    ...
    public CommonRecyclerViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_popular_recyclerview, viewGroup, false);
        return new PopularViewHolder(view, mContext);
    }
    ...
    public void onBindViewHolder(@NonNull CommonRecyclerViewHolder viewHolder, int position) {
        ((PopularViewHolder) viewHolder).onBind();
    }
