...
public class ChatImageRequester extends AbstractRequester {
    ...
    public ChatImageRequester(Context context) {
        super(context);
    ...
    protected Call genApi() {
        ...
        Call call = networkManager.getApi().chatFileRegister(partnerId, array);
        return call;
    }
    //----------------------------------------------------------------------------------------------
    // private
